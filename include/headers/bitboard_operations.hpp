...
namespace bitboard_operations {
    static constexpr void set_1(Bitboard &bb, const uint8_t square) {
        bb = bb | 1ull << square;
    }
    static constexpr void set_0(Bitboard &bb, const uint8_t square) {
        bb = bb & ~(1ull << square);
    }

    static constexpr bool get_bit(const Bitboard bb, const uint8_t square) {
