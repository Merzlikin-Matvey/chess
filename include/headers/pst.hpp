...
namespace chess::engine::pst {
    ...
    constexpr std::array mg_queen = {
        ...
        -14,   2, -11,  -2,  -5,   2,  14,   5,
        -35,  -8,  11,   2,   8,  15,  -3,   1,
         -1, -18,  -9,  11, -47, -27, -27, -23,
    };

    constexpr std::array mg_king = {
    ...
    constexpr std::array mg_table = {
        &mg_pawn, &mg_rook, &mg_knight, &mg_bishop, &mg_queen, &mg_king
    };
    constexpr std::array eg_table = {
        &eg_pawn, &eg_rook, &eg_knight, &eg_bishop, &eg_queen, &eg_king
    };
