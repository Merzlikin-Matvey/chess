...
double chess::engine::evaluate_position(Board& board, uint8_t color) {
    ...
    center_control_score += constants::knight * bitboard_operations::count_1(
                                                    board.piece_bitboards[color][chess::Knight] & constants::center);
    center_control_score += constants::bishop * bitboard_operations::count_1(
                                                    board.piece_bitboards[color][chess::Bishop] & constants::center);
    center_control_score +=
    ...
    center_control_score -= constants::queen * bitboard_operations::count_1(
                                                   board.piece_bitboards[!color][chess::Queen] & constants::center);
